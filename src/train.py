...
# type of model: "transformer", "rnn", "lstm"
...
torch.save(data_loader.word_id,f"Language_model/src/parameters/LMM_{model_type}.vocab_list")
torch.save(model.state_dict(),f"Language_model/src/parameters/LMM_{model_type}.state_dict")